...
void SceneStageSelect::Update() 
{
	...
	// 下ボタンを押したら 
	if (Input_I->IsKeyDown(VK_DOWN) || Input_I->IsButtonDown(0, GAMEPAD_BUTTON::DOWN)) {
		// 次のステージを選択する 
		mSelectedIndex += 1;
	...
	// 上ボタンを押したら 
	if (Input_I->IsKeyDown(VK_UP) || Input_I->IsButtonDown(0, GAMEPAD_BUTTON::UP)) {
		// 前のステージを選択する 
		mSelectedIndex -= 1;
...
void SceneStageSelect::Render() 
{
	...
	float originalColor[3] = { 1.0f, 1.0f, 1.0f };
